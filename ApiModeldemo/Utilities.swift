         ...
         //   showErrorMessage(text: prefix + " " + (textfield.placeholder?.lowercased())!)
            ...
            if (textfield.text?.first) == "0" {
                ...
                if (textfield.text?.count)! != 10
                {
                 ...
                 //   showErrorMessage(text: invalidprefix + " " + (textfield.placeholder?.lowercased())!)
                    return false
...
//            if textfield.text?.characters.count == 9 || textfield.text?.characters.count == 10 {
//                return true
//            }else{
//                return false
//            }
...
//    }
    ...
    class func isValidPassword(testStr:String) -> Bool {
        ...
        if (testStr.count >= 6) && (testStr.characters.count <= 12)  {
            return true
        }
        else{
            return false
...
//    class func ConvertDateToUTC(date: Date) -> Date {
//        let calender = Calendar.current
//        //let date1 = calender.startOfDay(for: date as Date)
//        var compo = calender.dateComponents([Calendar.Component.day,Calendar.Component.year,Calendar.Component.month,Calendar.Component.hour,Calendar.Component.minute,Calendar.Component.second], from: date as Date)
//        compo.hour = 0
//        compo.minute = 0
//        compo.second = 0
//    
//        let date1 = calender.date(from: compo)
//        let timeZoneOffset = Double(NSTimeZone.local.secondsFromGMT(for: date1! as Date))//NSTimeZone.system.daylightSavingTimeOffset()// as TimeInterval
//        // You could also use the systemTimeZone method
//        let gmtTimeInterval: TimeInterval = date1!.timeIntervalSinceReferenceDate - timeZoneOffset
//        return Date(timeIntervalSinceReferenceDate: gmtTimeInterval) as Date
//       // return gmtDate
//        //gmtDate.timeIntervalSince1970
//
...
////        let defaultTimeZoneStr = formatter.stringFromDate(date as Date)
////        // "2014-07-23 11:01:35 -0700" <-- same date, local, but with seconds
////        formatter.timeZone = NSTimeZone(abbreviation: "UTC") as TimeZone!
////        let utcTimeZoneStr = formatter.
//        }
//    
//    class func localDateFromUTC(timestamp: Double) -> NSDate {
//        let utcDate = NSDate(timeIntervalSince1970: Double(timestamp))
//        let localTimeZoneInSeconds = NSTimeZone.local.secondsFromGMT()
//        let localDate = utcDate.addingTimeInterval(TimeInterval(localTimeZoneInSeconds))
//        return utcDate
//    }
//    
...
//    }
//    
//    class func getFormatedTripDateInString(dateTime : NSDate) -> String {
//        let fmDate = DateFormatter()
...
//        
    ...
    class func BorderForTextFieldView(view : UIView)
    {
        ...
        view.layer.borderColor = UIColor(red: 243.0/255.0, green: 243.0/255.0, blue: 243.0/255.0, alpha: 1).cgColor
