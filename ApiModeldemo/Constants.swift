...
private let liveURL : String = "http://radioasianfever.co.uk/nhs/service/"
private let localURL : String = "http://radioasianfever.co.uk/nhs/service/"
...
let BundleIdentifier = "com.trpticdriver" //"com.peerbits.triptic"

let AppName = "TrpTic"

let DeviceType = "I"

var DeviceUDID = "djfhdskfhdkfjdkfdjdskldjkfdhk"

let UserTypeDriver = "D"

let UsertypePassenger = "U"
...
let SbnameAuthenticate = "Authentication"

let SbnameHome = "Home"

let SbnameVehicle = "Vehicles"

let SbnameSideMenu = "SideMenu"

let SbnameAddress = "Address"

let SbnameDelivery = "Delivery"

let SbnameTransaction = "Transaction"

let SbnameSettings = "Settings"

let SbnameInvite = "Invite"

let SbnameMyActivities = "MyActivities"

let SbnameProfile = "Profile"

let SbnameDocuments = "Documents"

let SbnameDiscount = "Discount"

let SbnameAddTrip = "AddTrip"

let SbnamePassengerList = "PassengerList"

let SbnamePassengerMessage = "PassengerMessage"

let SbnameHistory = "History"

let SbnamePayment = "Payment"

let SbnameFeedback = "Feedback"
...
let MyProfileNavController = "MyProfileNavigationController"

let myorderNavController = "myorderNavigationController"

let NavControllerMybookmarkServices = "MybookmarkServicesNavigationController"

let NavControllermySkillset = "mySkillsetNavigationController"

let NavControllersaveditem = "saveditemNavigationController"

let NavControllerMyactivity = "MyactivityNavigationController"

let NavControllerpreimumjobrequest = "preimumjobrequestNavigationController"

let NavControllersetting = "settingNavigationController"

let NavControllerinvite = "InviteNavigationController"

let NavControllerHistory = "historyNavigationController"

let NavControllerPayment = "paymentNavigationController"

let NavControllerAddTrip = "addTripNavController"

let NavControllerhelp = "helpNavigationController"

let NavControllerdiscount = "discountNavigationController"

let LanguageController = "LanguageViewController"

let LoginController = "LoginViewController"

let LoginVerificationController = "LoginVerificationViewController"

let ForgotPasswordController = "ForgotpasswordViewController"

let RegistrationController = "RegistrationViewController"

let CountryListController = "CountryListPopupController"
...
let CustomDefaultController = "CustomDefaultViewController"

let DocumentController = "DocumentViewController"

let VehicleInsuranceController = "VehicleInsuranceViewController"

let AddVehicleController = "AddVehicleViewController"

let vehicledoccontroller = "VehicleDocViewController"

let DriverIdDocController = "DriverDocumentViewController"

let DriverDocController = "AddDriverDocViewController"

let viewDriverDoumentController = "ViewDriverDocumentController"

let MyProfileController = "MyProfileViewController"

let EditProfileController = "EditProfileViewController"

let UploadProfilePictureController = "UploadProfilePictureViewController"

let DriverDocumentController = "DriverDocumentViewController"

let SearchListController = "SearchListViewController"

let TripDetailController = "TripDetailViewController"

let ExtendTripController = "ExtendTripViewController"

let EditTripController = "EditTripViewController"

let NotificationController = "NotificationViewController"

let BroadCastMsgController = "BroadCastMsgViewController"

let PassengerListController = "PassengerListViewController"

let AddPassengerController = "AddPassengerViewController"

let ConversationController = "ConversationViewController"

let PassengerMessageController = "PassengerMessageViewController"

let HistoryDetailController = "HistoryDetailViewController"

let FeedbackController = "FeedbackViewController"

let MessageTimeLineController = "MessageTimeLineViewController"

let AddNewTripController = "AddNewTripViewController"

let AddTripFromController = "AddTripFromViewController"

let HelpListController = "HelpListViewController"
...
enum WebLink : String
{
    case Terms = "terms/?lang=en"
    case FAQs = "faq/?lang=en"
    case Aboutus = "about/?lang=en"
    case PrivacyPolicy = "privacy/?lang=en"
    case LatePolicyConditions = "latepolicy/?lang=en"
}
...
enum Endpoint : String
{
    ...
    case CountryList = "default/countrylist/"
    case CityList = "default/citylist/"
    case Editprofile = "user/editprofile/"
    case VerifyOTP = "user/verifyotp/"
    case SendOTP = "user/sendotp/"
    case DialCode = "default/dialcodes/"
    case BrandList = "vehicle/brandlist/"
    case VehicleTypeList = "vehicle/typelist/"
    case VehicleList = "vehicle/vehiclelist/"
    case MasterData = "vehicle/masterdata/"
    case AddVehicle = "vehicle/addvehicle/"
    case UploadVehicle = "vehicle/uploadvehicledocument/"
    case GetProfile = "user/getprofile/"
    case verifyVehicle = "https://wasl.elm.sa/WaslPortalWeb/rest/VehicleRegistration/send"
    case verifyDocument = "https://wasl.elm.sa/WaslPortalWeb/rest/DriverRegistration/send"
    case uploadDriverDoc = "user/uploaddriverdocument"
    case nationalityList = "default/nationalitylist"
    case uploadVehicleDoc = "vehicle/uploadvehicledocument"
    case prefixMessage = "default/messagelist"
    case deleteNotification = "default/deletenotification"
    case tripMessage = "trip/tripmessages"
    case tripMaster = "trip/masterdata"
    case addTrip = "trip/addtrip"
    case extendTrip = "trip/extendtrip"
    case editTrip = "trip/edittrip"
    case tripTimeline = "trip/timeline"
    case tripList = "trip/triplist"
    case tripDetail = "trip/tripdetail"
    case tripHistory = "trip/history"
    case tripFeedback = "trip/feedback"
    case tripPassengerList = "trip/passengerlist"
    case SendMessage = "trip/sendmessage"
    case tripAddPassenger = "trip/addpassenger"
    case tripBroadCastMessage = "trip/broadcastmessage"
    case tripNotification = "default/notificationlist"
    case tripRequest = "trip/managetriprequest"
    
    
    //RAjYAGURU
    case getSetting = "user/getsetting"
    case setSetting = "user/setdriversetting"
    case changepassword = "user/changepassword"
    case setupdateLocation = "trip/updatelocation"
    case canceltrip = "trip/drivercanceltrip"
    case nondiscounttrip = "trip/nondiscountedtrips"
    case addtripdiscount = "trip/addtripdiscount"
    case driverstarttrip = "trip/starttrip"
    case driverendtrip = "trip/endtrip"
    
    case banklist = "default/banklist"
    case setBankDetails = "user/setbankdetail"
    case deleteBankDetails = "user/deletebankdetail"
